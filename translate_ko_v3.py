#!/usr/bin/env python3
"""
使用 Kimi API 批量翻译 europe-train.com 韩语文章中的英文段落
改进版：支持批量翻译和更好的错误处理
"""
import os
import re
...
PROPER_NOUNS = [
    ...
    'SNCF Connect', 'DB Navigator', 'Eurail Global Pass', 'Mont Cenis pass',
    'Mont d\'Ambin base tunnel', 'Egyptian Museum', 'PREM\'S', 'Super Economy',
    'BahnCard 25', 'Sparpreis', 'BahnCard', 'Swiss vignette'
]
